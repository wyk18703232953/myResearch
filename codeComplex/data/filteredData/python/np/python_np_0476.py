...
def main(n):
    ...
    # Example deterministic choice: k around 2*n//3 but at least 1 and at most n
    k = max(1, min(n, 2 * n // 3 if 2 * n // 3 > 0 else 1))

    # Deterministically generate l: positive integers with some structure
    # Mix of small and larger values to exercise gcd and factorization logic
    l = [i * (i % 5 + 2) for i in range(1, n + 1)]
