...
# -------------- main(n): generate test data and run --------------

def main(n):
    """
    n: grid width (original problem's n).
    We generate a k based on n for testing and print the result.
    """
    # Simple test data generation:
    # choose k in [0, 2*(n-2)] clipped to be non-negative and valid.
