...
class Matrix:
    ...
    def rotate(self):
        ...
        self.mat, self.r, self.c = copy.deepcopy(mat0.mat), self.c, self.r
        return self.mat
    ...
    def flipv(self):
        ...
        self.mat = copy.deepcopy(mat0.mat)
        return self.mat
...
def main(n):
    if n <= 0:
        return
    a1 = Matrix(n, n, generate_matrix_chars(n))
    a2 = Matrix(n, n, generate_matrix_chars(n))
    ans = []
    for _ in range(4):
