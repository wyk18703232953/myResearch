...
def main():
    """主函数"""
    # 文件路径
    input_file = '/home/wuyankai/myResearch/codeComplex/fit_v1/results/converted_stats.txt'
    output_file = '/home/wuyankai/myResearch/codeComplex/fit_v1/results/fit_f1_scores.txt'
