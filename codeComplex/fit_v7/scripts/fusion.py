...
def generate_statistics(base_dir):
    ...
    # 保存图片
    output_dir = os.path.join(os.path.dirname(base_dir), 'statistics')
    os.makedirs(output_dir, exist_ok=True)
    
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'accuracy_statistics.png'))
    print(f"\n统计图表已保存至: {os.path.join(output_dir, 'accuracy_statistics.png')}")
