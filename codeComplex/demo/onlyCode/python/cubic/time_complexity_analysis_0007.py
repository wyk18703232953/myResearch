...
# 读取原始代码
with open(r'd:\MyResearch\codeComplex\data\onlyCode\python\cubic\python_cubic_0007.py', 'r', encoding='utf-8') as f:
...
# 检查是否已经有部分结果
temp_results_path = r'D:/MyResearch/codeComplex/demo/onlyCode/python/cubic/results_0007/temp_results.npz'
...
try:
    ...
    # 保存最终结果
    final_results_path = r'D:/MyResearch/codeComplex/demo/onlyCode/python/cubic/results_0007/time_results.npz'
...
if len(test_results) >= 3:
    ...
    if fit_results:
        ...
        plt.title('Time Complexity Analysis - python_cubic_0007.py')
        plt.legend()
        plt.grid(True)
        plot_path = r'D:/MyResearch/codeComplex/demo/onlyCode/python/cubic/results_0007/time_complexity_plot.png'
        ...
        plt.xlabel('String Length (n)')
        plt.ylabel('Run Time (seconds)')
        plt.title('All Models Comparison - python_cubic_0007.py')
        plt.legend()
        plt.grid(True)
        comparison_path = r'D:/MyResearch/codeComplex/demo/onlyCode/python/cubic/results_0007/all_models_comparison.png'
        plt.savefig(comparison_path)
        plt.close()
        print(f'所有模型对比图已保存到 {comparison_path}')
        
        # 生成报告文件
        report_path = r'D:/MyResearch/codeComplex/demo/onlyCode/python/cubic/results_0007/time_complexity_report.txt'
        with open(report_path, 'w', encoding='utf-8') as f:
            f.write('Time Complexity Analysis Report\n')
            f.write('=' * 50 + '\n')
            f.write(f'分析的代码文件: python_cubic_0007.py\n')
